var TableFiles = (function () { 
  ...
  function TableFiles(container, data) {
      ...
      self._container.innerHTML = '\
        <table class="table table-striped">\
            ...
            <tfoot>\
              <tr>\
                <td colspan="3">\
                  <label for="inputFile'+ container +'">File input</label>\
                  <input type="file" multiple id="inputFile'+ container +'">\
                </td>\
              </tr>\
            </tfoot>\
          </table>';
    ...
    self._initSort = function (newCol, resort) {
      ...
      if (!self._curSortUp) {allTrs.reverse();}
    ...
    self._arrToSortIcon = function (newCol) {
      ...
      self._curSortUp ? icon.className='glyphicon glyphicon-arrow-up' : icon.className='glyphicon glyphicon-arrow-down';
    };
    ...
    self._addFilesFromData = function (files) {
      ...
      for (var key in files) {
       name = files[key].name;
        ...
        trs += '<tr id="'+ id +'" data-name="'+ 'name' + name +'"><td>'+ name +'</td><td>'+ size +'</td><td data-date="'+files[key].lastModifiedDate+'">'+ date +'</td></tr>';
      }
    ...
    self._addFiles = function (files) {
      ...
      for (var i=0; i < files.length; i++) {
        ...
        trs += '<tr id="'+ id +'" data-name="'+ 'name' + name +'"><td>'+ name +'</td><td>'+ size +'</td><td data-date="'+files[i].lastModifiedDate+'">'+ date +'</td></tr>';
      }
